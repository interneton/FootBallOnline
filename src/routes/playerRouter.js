...
import { equipPlayer, unequipPlayer, getAllPlayerStats, getInvenPlayerStats, createPlayer } from '../controllers/playerController.js';
...
router.get('/getAllPlayer', getAllPlayerStats); // 모든 선수 능력치 조회
router.get('/getInvenPlayer', authenticateToken, getInvenPlayerStats); // 보유 선수 능력치 조회
